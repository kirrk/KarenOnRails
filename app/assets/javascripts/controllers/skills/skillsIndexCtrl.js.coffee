@skillk.controller 'IndexCtrl', ['$scope', ($scope) ->
  $scope.skills =
    ...
    {shortname: 'css', description: 'With CSS being a mainstay in in every web project, it is a tool i\'ve used time and again; Sass is next on my list to learn.', alt: 'CSS', frequency: '2'}, {shortname: 'angular', description: 'I have worked with Angular, with CoffeeScript in a Rails context and also in a WordPress context. While I am rather new to this framework, the more I use it, the more I enjoy working with it.', alt: 'AngularJS', frequency: '3'},
      ...
      {shortname: 'aspnet', description: 'Although I do not get an opportunity to work with ASP.NET on a daily basis, I am currently wrapping a client\'s site using .NET (C#) and also completed a C# certificate program at UW.', alt: 'ASP.NET', frequency: '4'},  {shortname: 'bootstrap', description: 'With its innate responsiveness, Twitter Bootstrap is a staple tool in my arsenal. I have also used Zurb Foundation, but need to work more with Sass.', alt: 'Twitter Bootstrap', frequency: '2'},  {shortname: 'wordpress', description: 'I have developed numerous sites using Wordpress, both custom themes and child themes, often times also integrating Twitter Bootstrap.', alt: 'WordPress', frequency: '1'},  {shortname: 'drupal', description: 'I have also developed a couple sites using Drupal. Since it has custom fields built it into its core it can be a bit more flexible as a CMS.', alt: 'Drupal', frequency: '3'},
